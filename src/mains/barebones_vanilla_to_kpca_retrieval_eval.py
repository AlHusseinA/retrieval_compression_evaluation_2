...
from retrieval.run_retrieval_evaluation import run_retrieval_evaluation_kPCA
import numpy as np
import random
...
def main():
    ...
    # dir_retrieval_kpca = "/home/alabutaleb/Desktop/confirmation/Retrieval_eval_kPCA_evaluation"
    dir_retrieval_kpca = "/home/alabutaleb/Desktop/confirmation/Retrieval_eval_kPCA_evaluation_whiten_false"
    # dir_retrieval_kpca = "/home/alabutaleb/Desktop/confirmation/Retrieval_eval_kPCA_evaluation_whiten_true"
    ensure_directory_exists(dir_retrieval_kpca)
    ...
    # ##############################################################################    
    COMPRESSED_VECTOR_DIMS_kPCA = [1024, 512, 256, 128, 64, 32, 16, 8]


    ####################################################################################
    results_kPCA = run_retrieval_evaluation_kPCA(vanilla_model, trainloader_cub200, testloader_cub200, COMPRESSED_VECTOR_DIMS_kPCA, dir_retrieval_kpca, dataset_name, num_classes_cub200, batch_size, lr, top_k, device)

    save_retrieval_results(results_kPCA, f"{dir_retrieval_kpca}/results_dic_all_kPCA_retrieval_eval.pkl")
    plot_metrics(results_kPCA, top_k, COMPRESSED_VECTOR_DIMS_kPCA, dir_retrieval_kpca)
    plot_metrics_logarithmic(results_kPCA, top_k, COMPRESSED_VECTOR_DIMS_kPCA, dir_retrieval_kpca)
    save_retrieval_results(results_kPCA, f"{dir_retrieval_kpca}/results_dic_kPCA_resnet50.pkl")
